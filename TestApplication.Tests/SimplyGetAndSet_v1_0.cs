...
{
    [TestClass]
    public class SimplyGetAndSet_v1_0
    {
        /// <summary>
        ...
        public void InitBlankValue()
        {
            ...
            HttpWebRequest request =
                (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION);
            string result = TestHelpers_v1_0.DoRequest(request, cookieContainer);
        ...
        public void SetValueStringTwice()
        {
            ...
            HttpWebRequest request1 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_ACTION + textToSet1),
                request2 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_ACTION + textToSet2),
                request3 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION);
            TestHelpers_v1_0.DoRequest(request1, cookieContainer);
            TestHelpers_v1_0.DoRequest(request2, cookieContainer);
            string result = TestHelpers_v1_0.DoRequest(request3, cookieContainer);
        ...
        public void SingleSetValueInt()
        {
            CookieContainer cookieContainer = new CookieContainer();
            int intToSet = 1;
            HttpWebRequest request1 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_VAL_INT + intToSet),
                request2 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION);
            TestHelpers_v1_0.DoRequest(request1, cookieContainer);
            string result = TestHelpers_v1_0.DoRequest(request2, cookieContainer);
        ...
        {
            CookieContainer cookieContainer = new CookieContainer();
            HttpWebRequest request1 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_VAL_DECIMAL),
                request2 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION);
            TestHelpers_v1_0.DoRequest(request1, cookieContainer);
            string result = TestHelpers_v1_0.DoRequest(request2, cookieContainer);
        ...
        {
            CookieContainer cookieContainer = new CookieContainer();
            HttpWebRequest request1 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_VAL_BOOL + true),
                request2 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION),
                request3 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_VAL_BOOL + false),
                request4 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION);           
            ...
            TestHelpers_v1_0.DoRequest(request3, cookieContainer);
            result = TestHelpers_v1_0.DoRequest(request4, cookieContainer);
        ...
        public void SingleValueTwice()
        {
            ...
            HttpWebRequest request1 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_ACTION + textToSet1),
                request2 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION),
                request3 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_ACTION + textToSet2),
                request4 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION);
            TestHelpers_v1_0.DoRequest(request1, cookieContainer);
            string result = TestHelpers_v1_0.DoRequest(request2, cookieContainer);
        ...
        public void SessionAbandon()
        {
            ...
            HttpWebRequest request1 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SET_SESSION_ACTION + textToSet1),
                request2 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION),
                request3 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.SESSION_ABANDON_ACTION),
                request4 = (HttpWebRequest)WebRequest.Create(TestHelpers_v1_0.BASE_URL + TestHelpers_v1_0.PRINT_SESION_ACTION);
            TestHelpers_v1_0.DoRequest(request1, cookieContainer);
            string result = TestHelpers_v1_0.DoRequest(request2, cookieContainer);
